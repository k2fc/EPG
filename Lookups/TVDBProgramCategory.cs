...
{
    /// <summary>
    /// The class that describes a TVDB program category.
    /// </summary>
    public class TVDBProgramCategory
    {
        /// <summary>
        /// Get the collection of TVDB categories.
        /// </summary>
        public static Collection<TVDBProgramCategory> Categories
        {
            get
            {
                if (categories == null)
                    categories = new Collection<TVDBProgramCategory>();
                return (categories);
            }
        }
        ...
        /// </summary>
        public static string FileName { get { return ("TVDB Categories"); } }
        ...
        /// <summary>
        /// Get or set the general part of the description.
        /// </summary>
        ...
        private static Collection<TVDBProgramCategory> categories;
        ...
        /// <summary>
        /// Initialize a new instance of the TVDBProgramCategory class.
        /// </summary>
        public TVDBProgramCategory() { }
        ...
        public TVDBProgramCategory(string categoryTag, string description)
        {
        ...
        public static TVDBProgramCategory FindCategory(string categoryTag)
        {
            if (categories == null)
                return (null);

            foreach (TVDBProgramCategory category in categories)
            {
        ...
        public static string FindCategoryDescription(string inputString)
        {
            ...
            foreach (TVDBProgramCategory category in categories)
            {
                if (lowerCaseInputString == category.CategoryTag.ToLowerInvariant())
        ...
        {
            Logger.Instance.Write("Loading TVDB Program Categories from " + fileName);
        ...
        public static void AddCategory(string categoryTag, string description)
        {
            ...
            categories.Add(new TVDBProgramCategory(categoryTag.Trim().ToLowerInvariant(), description));
        }
        ...
        {
            Logger.Instance.Write("Saving TVDB Program Categories to " + fileName);
        ...
        public int CompareForSorting(TVDBProgramCategory category, string keyName)
        {
            switch (keyName)
            {
                case "CategoryTag":
                    if (categoryTag == category.CategoryTag)
                        return (GeneralDescription.CompareTo(category.GeneralDescription));
                    else
                        return (categoryTag.CompareTo(category.CategoryTag));
                case "Description":
                    if (GeneralDescription == category.GeneralDescription)
                        return (categoryTag.CompareTo(category.CategoryTag));
                    else
                        return (GeneralDescription.CompareTo(category.GeneralDescription));
                case "WMCDescription":
