...
namespace DVBServices
{
    ...
    /// </summary>
    internal class DishNetworkSeriesDescriptor : DescriptorBase
    {
        /// <summary>
        /// Get the series.
        /// </summary>
        ...
        public override int Index
        {
            ...
            {
                if (lastIndex == -1)
                    throw (new InvalidOperationException("DishNetworkSeriesDescriptor: Index requested before block processed"));
                return (lastIndex);
            }
        }
        ...
        /// </summary>
        internal DishNetworkSeriesDescriptor() { }
        ...
        internal override void Process(byte[] byteData, int index)
        {
            ...
            Array.Copy(byteData, index, debug, 0, 7);
        ...
        internal override void LogMessage()
        {
            ...
            Logger.ProtocolLogger.Write(Logger.ProtocolIndent + "DISH NETWORK SERIES DESCRIPTOR: Entry type: " + entryType + 
                " Series: " + series +
                " Episode: " + episode +                
                " Original air date: " + startDate + " " + originalAirDate +
                " Debug: " + Utils.ConvertToHex(debug));
        }
    }
}
