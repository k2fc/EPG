...
namespace DVBServices
{
    ...
    /// </summary>
    internal class DishNetworkSupplementaryDescriptor : DishNetworkTextDescriptor
    {
        /// <summary>
        /// Get the supplementary information.
        /// </summary>
        public byte[] SupplementaryInformation { get { return (supplementaryInformation); } }
        ...
        private byte[] supplementaryInformation;
        ...
        {
            supplementaryInformation = Utils.GetBytes(byteData, index, Length); 
        ...
        internal override void LogMessage()
        {
            ...
            Logger.ProtocolLogger.Write(Logger.ProtocolIndent + "DISH SUPPLEMENTARY DESCRIPTOR:" +
                " Info: " + Utils.ConvertToHex(supplementaryInformation));
        }
    }
}
