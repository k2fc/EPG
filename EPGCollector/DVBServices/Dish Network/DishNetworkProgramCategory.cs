...
{
    /// <summary>
    /// The class that describes an Dish Network program category entry.
    /// </summary>
    public class DishNetworkProgramCategory
    {
        /// <summary>
        /// Get the collection of program categories.
        /// </summary>
        public static Collection<DishNetworkProgramCategory> Categories
        {
            get
            {
                if (categories == null)
                    categories = new Collection<DishNetworkProgramCategory>();
                return (categories);
            }
        }
        ...
        /// </summary>
        public string DishNetworkDescription
        {
            get
            {
                if (description == null)
        ...
        private static Collection<DishNetworkProgramCategory> categories;
        private static Collection<DishNetworkProgramCategory> undefinedCategories;
        ...
        public DishNetworkProgramCategory(int categoryID, int subCategoryID, string description)
        {
        ...
        public static DishNetworkProgramCategory FindCategory(int categoryID, int subCategoryID)
        {
            if (categories == null)
                return (null);

            foreach (DishNetworkProgramCategory category in categories)
            {
        ...
        {
            Logger.Instance.Write("Loading Dish Network Program Categories from " + fileName);
        ...
        public static void AddCategory(int categoryID, int subCategoryID, string description)
        {
            foreach (DishNetworkProgramCategory category in Categories)
            {
                if (category.CategoryID == categoryID)
                {
                    ...
                    else
                    {
                        if (category.SubCategoryID == subCategoryID)
                        {
                            categories.Insert(categories.IndexOf(category), new DishNetworkProgramCategory(categoryID, subCategoryID, description));
                            return;
                        }
                    }
                }
            ...
            categories.Add(new DishNetworkProgramCategory(categoryID, subCategoryID, description));
        }
        ...
        {
            Logger.Instance.Write("Saving Dish Network Program Categories to " + fileName);
        ...
        public static void AddUndefinedCategory(int categoryID, int subCategoryID, string description, string sampleEvent)
        {
            if (undefinedCategories == null)
                undefinedCategories = new Collection<DishNetworkProgramCategory>();

            foreach (DishNetworkProgramCategory category in undefinedCategories)
            {
                if (category.CategoryID == categoryID)
                {
                    if (category.SubCategoryID == subCategoryID)
                    ...
                    else
                    {
                        if (category.SubCategoryID == subCategoryID)
                        {
                            undefinedCategories.Insert(undefinedCategories.IndexOf(category), new DishNetworkProgramCategory(categoryID, subCategoryID, description));
            ...
            undefinedCategories.Add(new DishNetworkProgramCategory(categoryID, subCategoryID, description));
            undefinedCategories[undefinedCategories.Count - 1].SampleEvent = sampleEvent;
            undefinedCategories[undefinedCategories.Count - 1].UsedCount++;
        }
