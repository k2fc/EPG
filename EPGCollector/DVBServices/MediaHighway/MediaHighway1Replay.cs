...
namespace DVBServices
{
    ...
    public class MediaHighway1Replay
    {
        ...
        internal void Process(byte[] byteData, int index)
        {
            ...
            {
                throw (new ArgumentOutOfRangeException("The MediaHighway1 Replay data caused a format exception"));
            }
            catch (OverflowException)
            {
                throw (new ArgumentOutOfRangeException("The MediaHighway1 Replay data caused an overflow exception"));
            }
        }
