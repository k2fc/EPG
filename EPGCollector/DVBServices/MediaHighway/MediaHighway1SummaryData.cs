    ...
    public class MediaHighway1SummaryData
    {
        ...
        internal void Process(byte[] byteData, int index)
        {
            ...
            try
            {
                ...
                shortDescription = Utils.GetString(byteData, lastIndex, byteData.Length - lastIndex, ReplaceMode.TransferUnchanged);
            ...
            {
                throw (new ArgumentOutOfRangeException("The MediaHighway1 Summary Data message caused a format exception"));
            }
            catch (OverflowException)
            {
                throw (new ArgumentOutOfRangeException("The MediaHighway1 Summary Data message caused an overflow exception"));
            }
        }
