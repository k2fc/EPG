...
namespace DVBServices
{
    ...
    /// </summary>
    public class EITChannelInfoEntry
    {
        /// <summary>
        /// Get the service ID.
        /// </summary>
        ...
        public int Index
        {
            ...
            {
                if (lastIndex == -1)
                    throw (new InvalidOperationException("EITChannelInfoEntry: Index requested before block processed"));
                return (lastIndex);
            }
        }
        ...
        internal void Process(byte[] byteData, int index)
        {
            ...
            {
                throw (new ArgumentOutOfRangeException("The EIT Channel Info Entry message is short"));
            }
        }
        ...
        internal void LogMessage()
        {
            ...
            Logger.ProtocolLogger.Write(Logger.ProtocolIndent + "EIT CHANNEL INFO ENTRY");

            Logger.ProtocolLogger.Write(Logger.ProtocolIndent + "Service ID: " + serviceID +
                " User No: " + userNumber +
