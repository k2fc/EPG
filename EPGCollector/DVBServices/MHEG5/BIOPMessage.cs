        ...
        public int Index
        {
            get
            {
                ...
                if (messageDetail != null)
                    ...
                    return (noDetailIndex + messageSize);
            }
        }
                ...
                else
                {
                    ...
                    else
                    {
                        if (Utils.CompareBytes(objectKindData, biopSRG))
                        {
                            ...
                            Logger.Instance.Write("Unprocessed object type: " + Utils.ConvertToHex(objectKindData));
                    }
                }
