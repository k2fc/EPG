...
namespace DVBServices
{
    ...
    public class DSMCCDownloadServerInitiate : DSMCCMessage
    {
        ...
        /// </summary>
        public GroupInfoIndication GroupInfoIndication { get { return (groupInfoIndication); } }
        ...
        private GroupInfoIndication groupInfoIndication;
        ...
        public override void Process(byte[] byteData, int index)
        {
            ...
            try
            {
                ...
                if (privateDataLength != 0)
                {
                    ...
                    {
                        serviceGateWayInfo = null;

                        groupInfoIndication = new GroupInfoIndication();
                        groupInfoIndication.Process(byteData, lastIndex);
                        lastIndex = groupInfoIndication.Index;
                    }
                }
        ...
        public override void LogMessage()
        {
            ...
            if (groupInfoIndication != null)
            {
                Logger.IncrementProtocolIndent();
                groupInfoIndication.LogMessage();
                Logger.DecrementProtocolIndent();
            }
        }
    }
