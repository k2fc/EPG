    ...
    public class BellTVSection
    {
        ...
        public void Process(byte[] byteData, Mpeg2ExtendedHeader mpeg2Header)
        {
            ...
            while (lastIndex < byteData.Length - 4)
            {
                ...
                epgEntry.EventName = EditSpec.ProcessTitle(bellTVEntry.EventName);
                ...
                epgEntry.ShortDescription = EditSpec.ProcessDescription(bellTVEntry.ShortDescription);
        ...
        {
            epgEntry.ParentalRating = ParentalRating.FindRating("USA", "BELLTV", entry.ParentalRating.ToString());
            epgEntry.MpaaParentalRating = ParentalRating.FindMpaaRating("USA", "BELLTV", entry.ParentalRating.ToString());
            epgEntry.ParentalRatingSystem = ParentalRating.FindSystem("USA", "BELLTV", entry.ParentalRating.ToString());            
        }
