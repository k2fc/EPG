...
namespace DVBServices
{
    ...
    /// </summary>
    internal class BellTVRatingDescriptor : DescriptorBase
    {
        /// <summary>
        /// Get the star rating.
        /// </summary>
        ...
        public override int Index
        {
            ...
            {
                if (lastIndex == -1)
                    throw (new InvalidOperationException("BellTVRatingDescriptor: Index requested before block processed"));
                return (lastIndex);
            }
        }
        ...
        /// </summary>
        internal BellTVRatingDescriptor() { }
        ...
        internal override void LogMessage()
        {
            ...
            Logger.ProtocolLogger.Write(Logger.ProtocolIndent + "BELL TV RATING DESCRIPTOR: Star rating: " + starRating +
