...
namespace DomainObjects
{
    ...
    public class Tuner
    {
        ...
        /// </summary>
        public virtual TunerNode DVBSatelliteNode
        {
            get
            {
                if (TunerNodes == null)
        ...
        /// </summary>
        public virtual TunerNode DVBTerrestrialNode
        {
            get
            {
                if (TunerNodes == null)
        ...
        /// </summary>
        public virtual TunerNode DVBCableNode
        {
            get
            {
                if (TunerNodes == null)
        ...
        /// </summary>
        public virtual bool IsServerTuner { get { return (false); } }

        /// <summary>
        /// Returns false. Overridden in derived classes.
        /// </summary>
        public virtual bool IsSatIpTuner { get { return (false); } }

        /// <summary>
        /// Returns false. Overridden in derived classes.
        /// </summary>
        public virtual bool IsVBoxTuner { get { return (false); } }
        ...
        { 
            get { return ((TunerCollection.IndexOf(this) + 1).ToString()); }
            set { }
        }
