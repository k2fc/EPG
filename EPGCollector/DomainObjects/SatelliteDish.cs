...
namespace DomainObjects
{
    ...
    public class SatelliteDish
    {
        ...
        public static SatelliteDish Default
        {
            get
            {
                if (defaultList == null)
                {
                    ...
                    SatelliteDish default6 = new SatelliteDish();
                    default6.LNBLowBandFrequency = 11250000;
                    default6.LNBHighBandFrequency = 11250000;
                    default6.LNBSwitchFrequency = 0;
                    defaultList.Add(default6);
        ...
        private LNBType lnbType = new LNBType(LNBType.Legacy);
