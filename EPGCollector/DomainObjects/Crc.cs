...
namespace DomainObjects
{
    ...
    public sealed class Crc
    {
        ...
        public static long CalculateCRC(string stringData)
        {
            byte[] crcBytes = Encoding.Unicode.GetBytes(stringData);
            return (CalculateCRC(crcBytes, 0, crcBytes.Length));
        }
        ...
        /// <returns>The crc.</returns>
        public static long CalculateCRC(byte[] byteData, int offset, int length)
        {
            uint crc = 0xffffffff;
