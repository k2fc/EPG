...
namespace DirectShowAPI
{
    ...
    public enum CDef
    {
        ...
        /// <summary>
        /// Device monitor for device.
        /// </summary>
        DevmonCMGRDevice = 0x0010,
        /// <summary>
        /// Device monitor for DMO's.
        /// </summary>
        DevmonDMO = 0x0020,
        /// <summary>
        /// Device monitor for plug and play.
        /// </summary>
        DevmonPNPDevice = 0x0040,
        /// <summary>
        /// Device monitor for filter.
        /// </summary>
        DevmonFilter = 0x0080,
        /// <summary>
        /// Device monitor all.
    ...
    public interface ICreateDevEnum
    {
        ...
        /// <param name="ppEnumMoniker">The returned moniker.</param>
        /// <param name="dwFlags">Flags controlling the enumerator.</param>
    ...
    public class DsInt
    {
        ...
        /// </summary>
        /// <param name="l">The System.Int32 to wrap into a DirectShowLib.DsInt</param>
    ...
    public class DsShort
    {
        ...
        /// </code>
        /// </summary>
        /// <param name="l">DirectShowLib.DsShort to be cast</param>
        ...
        /// </summary>
        /// <param name="l">The System.Int16 to wrap into a DirectShowLib.DsShort</param>
    ...
    /// <summary>
    /// Utilty class for handling errors.
    /// </summary>
    public static class DsError
    {
        ...
        /// (values less than 0) and Status codes (values >= 0)
        /// </summary>
    ...
    public static class DsUtils
    {
        ...
        public static Pilot GetNativePilot(SignalPilot.Pilot pilot)
        {
            switch (pilot)
            {
                case SignalPilot.Pilot.NotDefined:
                    return (Pilot.NotDefined);
                case SignalPilot.Pilot.NotSet:
                    return (Pilot.NotSet);
                case SignalPilot.Pilot.Off:
                    return (Pilot.Off);
                case SignalPilot.Pilot.On:
                    return (Pilot.On);
                default:
                    return (Pilot.NotSet);
            }
        ...
        public static RollOff GetNativeRollOff(SignalRollOff.RollOff rollOff)
        {
            switch (rollOff)
            {
                case SignalRollOff.RollOff.NotDefined:
                    return (RollOff.NotDefined);
                case SignalRollOff.RollOff.NotSet:
    ...
    /// <summary>
    /// Utility class for handling pins.
    /// </summary>    
