...
{
    /// <summary>
    /// The class that describes an XMLTV star rating tag.
    /// </summary>
    public class XmltvStarRating
    {
        /// <summary>
        /// Get the system.
        /// </summary>
        ...
        private bool load(XmlReader xmlReader)
        {
            ...
            {
                Logger.Instance.Write("Failed to load xmltv star rating");
        ...
        public static XmltvStarRating GetInstance(XmlReader xmlReader)
        {
            XmltvStarRating instance = new XmltvStarRating();
