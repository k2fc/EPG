...
namespace XmltvParser
{
    ...
    /// </summary>
    public class XmltvProgramCategory
    {
        /// <summary>
        /// Get the collection of TVDB categories.
        /// </summary>
        public static Collection<XmltvProgramCategory> Categories
        {
            get
            {
                if (categories == null)
                    categories = new Collection<XmltvProgramCategory>();
                return (categories);
            }
        }
        ...
        private static Collection<XmltvProgramCategory> categories;
        ...
        /// <summary>
        /// Initialize a new instance of the XmltvProgramCategory class.
        /// </summary>
        public XmltvProgramCategory() { }
        ...
        public XmltvProgramCategory(string categoryTag, string description)
        {
        ...
        public static XmltvProgramCategory FindCategory(string categoryTag)
        {
            if (categories == null)
                return (null);

            foreach (XmltvProgramCategory category in categories)
            {
        ...
        {
            Logger.Instance.Write("Loading XMLTV Program Categories from " + fileName);
        ...
        public static void AddCategory(string categoryTag, string description)
        {
            ...
            categories.Add(new XmltvProgramCategory(categoryTag.Trim().ToLowerInvariant(), description));
        }
        ...
        {
            Logger.Instance.Write("Saving XMLTV Program Categories to " + fileName);
        ...
        public int CompareForSorting(XmltvProgramCategory category, string keyName)
        {
            switch (keyName)
            {
                case "CategoryTag":
